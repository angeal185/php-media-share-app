    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-body text-center">
                ...
                <br/>
                <p style="color:grey">You have forgotten your password? To recover it, please type your Username and E-Mail Address.</p>
                <form method="POST" role="form" class="m-t">
                    <div class="form-group">
                        <label class="control-label" style="color:black">Username</label>
                        <input type="text" placeholder="Username" title="Please enter you username" name="forgot_user" class="form-control" required>
						<br />
						<label class="control-label" style="color:black">E-Mail Address</label>
                        <input type="text" placeholder="E-Mail Address" title="Please enter you E-Mail Address" name="forgot_email" class="form-control" required >
                    </div>
                    <button class="btn btn-primary block full-width" type="submit">Recover Password</button>
                </form>
            </div>
        </div>
        </div>
